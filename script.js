                ...
                <div class="location-content">
                    ...
                    <div class="gallery-container">
                        <div class="gallery-item">
                            <img src="images/naples2.png" alt="Red Tide Notice at Naples Beach" class="gallery-image", ,link rel="preload">
                    ...
                    <div class="gallery-container">
                        <div class="gallery-item">
                            <img src="images/naples3.png" alt="Red Tide Conditions: Dark water, fish kills, lobster forced into shallow water for oxygen" class="gallery-image", ,link rel="preload">
...
<div class="location-content">
    ...
    <div id="gainesville-research" class="tab-content" style="display: block;">
        ...
        <div id="gainesville-research_projects" class="nested-tab-content" style="display: block;">
            ...
            <div class="gallery-container">
                <div class="gallery-item">
                    <img src="images/research5.png" alt="Poster presented at Fall Undergraduate Research Symposium (2022)" class="gallery-image", ,link rel="preload">
        ...
        <div id="gainesville-gallery" class="nested-tab-content" style="display: none;">
            ...
            <div class="gallery-container">
                <div class="gallery-item">
                    <img src="images/research1.jpeg" alt="Sampling surface water for Creative Campus Project at Clam Pass Park, a mangrove estuary (2020)" class="gallery-image", ,link rel="preload">
                    <p class="gallery-caption">Sampling surface water for Creative Campus Project at Clam Pass Park, a mangrove estuary (2020)</p>
                </div>
                <div class="gallery-item">
                    <img src="images/research2.jpeg" alt="Cutting samples from used commercial HVAC filter (2022)" class="gallery-image", ,link rel="preload">
                    <p class="gallery-caption">Cutting samples from used commercial HVAC filter (2022)</p>
                </div>
                <div class="gallery-item">
                    <img src="images/research3.jpeg" alt="AC filter project prepared samples (2022)" class="gallery-image", ,link rel="preload">
                    <p class="gallery-caption">AC filter project prepared samples (2022)</p>
                </div>
                <div class="gallery-item">
                    <img src="images/research4.jpeg" alt="HPLC-Mass Spectrometer (2022)" class="gallery-image", ,link rel="preload">
    ...
    <div id="gainesville-involvement" class="tab-content" style="display: none;">
        ...
        <div id="gainesville-ursp" class="nested-tab-content" style="display: none;">
            ...
            <div class="gallery-container">
                <div class="gallery-item">
                    <img src="images/ursp.jpeg" alt="Touring HiPerGator NVIDIA Supercomputer (2023)" class="gallery-image", ,link rel="preload">
        ...
        <div id="gainesville-ursp_advisory_board" class="nested-tab-content" style="display: none;">
            ...
            <div class="gallery-container">
                <div class="gallery-item">
                    <img src="images/uab.jpeg" alt="URSP Advisory Board (2023)" class="gallery-image", ,link rel="preload">
        ...
        <div id="gainesville-tbp" class="nested-tab-content" style="display: block;">
            ...
            <div class="gallery-container">
                <div class="gallery-item">
                    <img src="images/tbp1.jpeg" alt="TBP FL-A Spring 2024 Initiates" class="gallery-image", ,link rel="preload">
                    <p class="gallery-caption">TBP FL-A Spring 2024 Initiates</p>
                </div>
            </div>
            <div class="gallery-container">
                <div class="gallery-item">
                    <img src="images/tbp2.jpeg" alt="Kennedy Space Center Visit (2024)" class="gallery-image", ,link rel="preload">
    ...
    <div id="gainesville-projects" class="tab-content" style="display: none;">
        ...
        <div class="gallery-container">
                <div class="gallery-item">
                    <img src="images/freecycle.png" alt="Sample page of FREEcycle" class="gallery-image", ,link rel="preload">
    ...
    <div id="gainesville-coursework" class="tab-content" style="display: none;">
        ...
        },
        {
            ...
            <div class="location-content">
                ...
                <img src="images/fdep.png" alt="FDEP" class="location-image", ,link rel="preload">
                <br>
        ...
        },
        {
            ...
            <div class="location-content">
                ...
                <img src="images/epa1.jpeg" alt="NVFEL" class="location-image", ,link rel="preload">
                <br>
                <i style="display: inline;">
                ...
                <div class="gallery-container">
                    <div class="gallery-item">
                        <img src="images/epa2.JPG" alt="Team Photo (2023)" class="gallery-image", ,link rel="preload">
                ...
                <div class="gallery-container">
                    <div class="gallery-item">
                        <img src="images/epa3.png" alt="Sample AIS Classification results using LA/Long Beach Dataset" class="gallery-image", ,link rel="preload">
        ...
        },
        {
            ...
            <div class="location-content">
                <h3>Reno, Nevada</h3>
                <img src="images/reno1.jpg" alt="Giga Nevada" class="location-image", ,link rel="preload">
                <br>
                <i style="display: inline;">
                ...
                <div class="gallery-container">
                    <div class="gallery-item">
                        <img src="images/reno2.jpeg" alt="Inside Gigafactory 1 (Sparks, Nevada)" class="gallery-image", ,link rel="preload">
                        <p class="gallery-caption">Inside Gigafactory 1 (Sparks, Nevada)</p>
                    </div>
                    <div class="gallery-item">
                        <img src="images/reno3.jpg" alt="Intern Cohort" class="gallery-image", ,link rel="preload">
                        <p class="gallery-caption">Intern Cohort</p>
                    </div>
                    <div class="gallery-item">
                        <img src="images/reno4.jpeg" alt="Cybertruck (Pre-Launch)" class="gallery-image", ,link rel="preload">
        ...
        },
        {
            ...
            <div class="location-content">
                ...
                <img src="images/fremont1.jpg" alt="Fremont Factory" class="location-image", ,link rel="preload">
                <br>
                <i style="display: inline;">
                ...
                <div class="gallery-container">
                    <div class="gallery-item">
                        <img src="images/fremont2.jpeg" alt="Outside Tesla Fremont Factory (2024)" class="gallery-image", ,link rel="preload">
                        <p class="gallery-caption">Outside Tesla Fremont Factory (2024)</p>
                    </div>
                    <div class="gallery-item">
                        <img src="images/fremont3.jpeg" alt="Pointing at Fremont Factory from Mission Peak (2024)" class="gallery-image", ,link rel="preload">
        ...
        },
        {
            ...
            <div class="location-content">
                ...
                <img src="images/iceland1.png" alt="UFIC" class="location-image", ,link rel="preload">
                <br>
                ...
                <div class="gallery-container">
                    <div class="gallery-item">
                        <img src="images/iceland2.jpg" alt="UF Group inside ON Geothermal Facility" class="gallery-image", ,link rel="preload">
                        <p class="gallery-caption">UF Group inside ON Geothermal Facility</p>
                    </div>
                    <div class="gallery-item">
                        <img src="images/iceland3.jpg" alt="UF Group at Ocean Cluster" class="gallery-image", ,link rel="preload">
                        <p class="gallery-caption">UF Group at Ocean Cluster</p>
                    </div>
                    <div class="gallery-item">
                        <img src="images/iceland4.jpg" alt="UF Group at Icelandic Althing, the Oldest Parliament in the World" class="gallery-image", ,link rel="preload">
                    ...
                    <div class="gallery-item">
                        <img src="images/iceland8.jpeg" alt="CO2 and Perlan Museum Observatory" class="gallery-image", ,link rel="preload">
        ...
        },
        {
            ...
            <div class="location-content">
                ...
                <img src="images/bel1.png" alt="Belgium/US Flags" class="location-image", ,link rel="preload">
                <br>
                <i style="display: inline;">
                ...
                <div class="gallery-container">
                    <div class="gallery-item">
                        <img src="images/bel2.png" alt="Classic Belgian Frites Stand (2011)" class="gallery-image", ,link rel="preload">
                        <p class="gallery-caption">Classic Belgian Frites Stand (2011)</p>
                    </div>
                    <div class="gallery-item">
                        <img src="images/bel3.JPG" alt="My brother and I at "Mini Europe" (2017) in Brussels, Atomium in Background" class="gallery-image", ,link rel="preload">
                        <p class="gallery-caption">My brother and I at "Mini Europe" (2017) in Brussels, Atomium in Background</p>
                    </div>
                    <div class="gallery-item">
                        <img src="images/bel4.JPG" alt="(Electric) Train at Gare de Liège-Guillemins (2011)" class="gallery-image", ,link rel="preload">
